...
fun day23_1(lines: List<String>): Any {
    // Ex part1
//    val startState = listOf(room2[1], room4[0], room3[0], room3[1], room1[1], room4[1], room1[0], room2[0])
...
//    val start = State(4, startState)
    ...
    val startState = listOf(
        ...
        room2[2], room3[0], room3[1], room3[3],
        room1[3], room2[1], room4[2], room4[3],
        room1[0], room1[1], room1[2], room2[0],
    )
    val start = State(4, startState)
...
//        run("1", fileName = "day23_dummy.txt", func = ::day23_1)
    ...
    println(day23_1(readInput("$DAY/ExampleTest")))
}